    ...
    <div className="p-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="cursor-pointer flex items-center gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white  hover:from-indigo-700 hover:to-purple-700  px-4 py-2 rounded-lg hover:bg-red-500 transition-colors duration-300"
        >
